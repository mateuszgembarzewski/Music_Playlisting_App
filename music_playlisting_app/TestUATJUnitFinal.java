...
public class TestUATJUnitFinal {
    ...
    /**
     * Test 29: Verifies that an artist can delete a song from the catalog if it's present
    ...
    /**
     * Test 30: Verifies that an artist does not delete song from the catalog when it is not present
    ...
    /**
     * Test 31: Verifies that an artist can delete a song from the catalog, and it is also removed from playlists where it exists
    ...
    /**
     * Test 32: Verifies that an artist can delete a song from the catalog, and it is not removed from playlists where it does not exist
